...
2. 혼자 쓰기 막막하면 Chat 모드에서 Continue에게 초안을 같이 만들어달라고 요청합니다.
   ...
   [Output Format] 실습 3-1(03_todo_app)의 PRD와 같은 형식
...
2. 실습 3-1(`03_todo_app`)에서 했던 것처럼, 파일이 만들어지는 과정을 관찰하며 하나씩 **Keep**/**Undo**로 확인합니다.
3. 기능을 다듬을 때는 실습 1에서 배운 TCCOV 형식을 활용합니다.
   ...
   ```
4. `02_context_lab`에서 배운 것처럼, 본인의 실제 기술 스택/컨벤션을 설명해주면 더 정확한 답변을 받을 수 있습니다.

### 막히면
- 에러 메시지를 그대로 복사해서 붙여넣고 "이 에러 고쳐줘"라고 요청합니다.
- 실습 3-2(`04_todo_advanced`)에서 했던 것처럼 코드 리뷰, 리팩토링 요청도 자유롭게 활용합니다.
